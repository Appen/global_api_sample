...
| Document |  available_to_user_email |  Available_to_user_email specifies a user in Appen Global that will have access to work on the document by their email in the system | If specified, only this user will be able to work on the document.<br> If the email doesn't exist in Appen Global, it will be ignored and the document will be available to any judge. |
